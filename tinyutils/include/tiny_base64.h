...
#ifndef TINY_BASE_THIRD_PARTY_BASE64_BASE64_H_
#define TINY_BASE_THIRD_PARTY_BASE64_BASE64_H_
...
namespace tiny {
    ...
    public:
        ...
        static inline std::string Decode(const std::string& data) {
            std::string result;
            DecodeFromArray(data.data(), data.size(), DO_STRICT, &result, nullptr);
            return result;
        }
...
#endif /* TINY_BASE_THIRD_PARTY_BASE64_BASE64_H_ */
