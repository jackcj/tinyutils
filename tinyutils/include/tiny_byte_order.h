...
#error Define either ARCH_IS_LITTLE_ENDIAN or ARCH_IS_BIG_ENDIAN
#endif


#include <stdint.h>

#if defined(UNI_POSIX) && !defined(__native_client__)
#include <arpa/inet.h>
#endif
...
#elif defined(UNI_WIN) || defined(__native_client__)
...
#endif  // defined(__native_client__)
#else
#error ARCH_IS_BIG_ENDIAN or ARCH_IS_LITTLE_ENDIAN must be defined.
#endif  // defined(ARCH_IS_LITTLE_ENDIAN)

#elif defined(UNI_POSIX)
#include <endian.h>
#else
#error "Missing byte order functions for this arch."
#endif  // defined(UNI_MAC)
